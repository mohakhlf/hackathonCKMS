...
class HomeController extends AbstractController
{
    ...
    public function index()
    {
        ...
        $response = $client->request("GET", "https://api.windy.com/api/webcams/v2/list/country=US?key=zstN1Wb3W5GWTdmXMHvyScEs7TXJdpWL");
        $object= $client->request("GET","https://api.windy.com/api/webcams/v2/list/continent=EU?key=zstN1Wb3W5GWTdmXMHvyScEs7TXJdpWL")
